...
def guess(word, answer, letterPrev):
    ...
    for i in range(len(word)):
        if word[i] == answer[i]:
            output[i] = "\033[4;38;2;0;0;0;48;2;13;188;121m" + " "  + word[i] + " "  + "\033[0m"
            letterOcc[word[i]] -= 1
    ...
    for i in range(len(word)):
        if word[i] in answer:
            if letterOcc[word[i]] > 0:
                letterOcc[word[i]] -= 1
                output[i] = "\033[4;38;2;0;0;0;48;2;200;160;9m" + " "  + word[i] + " "  + "\033[0m"
                if letterPrev[word[i]] == word[i]:
                    letterPrev[word[i]] = "\033[38;2;200;160;9m" + word[i] + "\033[0m"
            else:
                output[i] = "\033[4;38;2;0;0;0;48;2;102;102;102m" + " " + word[i] + " "  + "\033[0m"
        elif word[i] != "X":
            output[i] = "\033[4;38;2;0;0;0;48;2;102;102;102m" + " "  + word[i] + " "  + "\033[0m"
...
guessNum = 0
guesses = [" ".join(["\033[4;38;2;0;0;0;48;2;102;102;102m   \033[0m"]*length)]*numOfGuesses
